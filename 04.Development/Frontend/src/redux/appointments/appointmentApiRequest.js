...
export const getAllAppointment = async (accessToken, dispatch, userID, upID, pageNo, pageSize, appointmentStatus) => {
    dispatch(getAppointmentsStart())
    try{
        const res = await axios.get(BASE_APPOINTMENT_URL + "/" + userID 
